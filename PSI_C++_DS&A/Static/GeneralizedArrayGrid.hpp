...
#ifndef GENERALARRAYGRID_HPP
#define GENERALARRAYGRID_HPP
...
class GeneralArrayGrid {
	public:
		...
		*/
		...
		Example:
		*/
		GeneralArrayGrid& operator==(const GeneralArrayGrid &rhs){};
		/*
		Name:	
		Description:
		Input:
		...
		*/
		...
		Example:
		*/
		GeneralArrayGrid& operator*(const int &rhs){};
		/*
		Name:	
		Description:
		Input:
